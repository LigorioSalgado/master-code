...
// La segunda clase va arepresentar el arbol en sí
...
class Tree {
  ...
  add(dato) {
    if (this.root === null) {
      ...
      return; // Porque quiero que aquí acabe el método
    }
    var currentNode = this.root;
    while (true) {
      //loop infinito. Aquí es donde se empieza a buscar
      if (dato < currentNode.dato) {
        ...
        //aquí voy a programar la derecha
  ...
  contains(dato) {
    //Solo verifica si existe el dato en el árbol
